...
import { ZardSelectItemComponent } from '../../select/select-item/select-item.component';
import { ZardSelectComponent } from '../../select/select/select.component';
...
@Component({
  ...
  styleUrl: './calendar-navigation.component.css',
})
